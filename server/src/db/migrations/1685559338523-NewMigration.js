...
module.exports = class NewMigration1685559338523 {
    name = 'NewMigration1685559338523'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "View" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userIp" character varying NOT NULL, "videoId" uuid NOT NULL, CONSTRAINT "PK_b2885c8b6da2c379324609ce485" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Video" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL DEFAULT '', "flags" text array NOT NULL DEFAULT ARRAY['public'], "viewsCount" integer NOT NULL DEFAULT '0', "likesCount" integer NOT NULL DEFAULT '0', "duration" integer NOT NULL DEFAULT '0', "description" text NOT NULL DEFAULT '', "video_path" character varying NOT NULL DEFAULT '', "thumbnail_path" character varying NOT NULL DEFAULT '', "user_id" uuid NOT NULL, CONSTRAINT "PK_2a23c3da7a2fc570b1696191b87" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Like" ADD CONSTRAINT "FK_116acc50657a08886928d5269d6" FOREIGN KEY ("from_user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Like" ADD CONSTRAINT "FK_6c7de771ed37d3278fa6dd2ea21" FOREIGN KEY ("to_video_id") REFERENCES "Video"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "View" ADD CONSTRAINT "FK_57802911da1bc896b68ff3debcc" FOREIGN KEY ("videoId") REFERENCES "Video"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Video" ADD CONSTRAINT "FK_287e5cf7671bef66254834de3fb" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Comment" ADD CONSTRAINT "FK_35807048116cf822fd0ef9c0299" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Comment" ADD CONSTRAINT "FK_ee3208e6011f580f1022169a56b" FOREIGN KEY ("video_id") REFERENCES "Video"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "View" DROP CONSTRAINT "FK_57802911da1bc896b68ff3debcc"`);
