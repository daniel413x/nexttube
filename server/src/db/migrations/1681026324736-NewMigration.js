...
module.exports = class NewMigration1681026324736 {
    name = 'NewMigration1681026324736'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL DEFAULT '', "flags" text array NOT NULL DEFAULT ARRAY['registered'], "subscribers_count" integer NOT NULL DEFAULT '0', "description" text NOT NULL DEFAULT '', "avatar_path" character varying NOT NULL DEFAULT '', CONSTRAINT "UQ_4a257d2c9837248d70640b3e36e" UNIQUE ("email"), CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`);
