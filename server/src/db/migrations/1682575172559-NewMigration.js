...
module.exports = class NewMigration1682575172559 {
    name = 'NewMigration1682575172559'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "View" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userIp" character varying NOT NULL, "videoId" character varying NOT NULL, CONSTRAINT "PK_b2885c8b6da2c379324609ce485" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Video" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL DEFAULT '', "flags" text array NOT NULL DEFAULT ARRAY['isPublic'], "viewsCount" integer NOT NULL DEFAULT '0', "likesCount" integer NOT NULL DEFAULT '0', "duration" integer NOT NULL DEFAULT '0', "description" text NOT NULL DEFAULT '', "video_path" character varying NOT NULL DEFAULT '', "thumbnail_path" character varying NOT NULL DEFAULT '', "user_id" uuid NOT NULL, CONSTRAINT "PK_2a23c3da7a2fc570b1696191b87" PRIMARY KEY ("id"))`);
